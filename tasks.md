...
Nothing started yet. Next available: **T1**.

---

## Phase 0 — Repository Bootstrap

- [ ] **T1 — Bootstrap monorepo** 🔧🛰️
...
- [ ] **T2 — apps/api skeleton + health endpoint** 🔧
...
- [ ] **T5 — packages/ocpp-schemas scaffold** 🛰️
...
- [ ] **T7 — Charge point + connector CRUD (API + repos)** 🔧
...
- [ ] **T11 — Vue realtime client + LiveLogPanel** 🔧
...
- [ ] **T12 — Official 1.6J schemas + validator** 🛰️
...
- [ ] **T15 — CSMS happy-path handlers** 🛰️
...
- [ ] **T17 — End-to-end connect + BootNotification** 🔧🛰️ (tracks converge)
